...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // 1. Envolvemos todo en el fondo de WhatsApp
      body: FondoWhatsApp(
        child: SafeArea(
          child: Center(
            ...
            child: BlocConsumer<AuthBloc, AuthState>(
              ...
              builder: (context, state) {
                // AQUÍ ESTÁ LA CORRECCIÓN DE DISEÑO RESPONSIVO
                return Center(
                  child: ConstrainedBox(
                    constraints: const BoxConstraints(
                      maxWidth: 400, // Límite de ancho para pantallas grandes
                    ),
                    child: Form(
                      key: _formKey,
                      child: Column(
                        ...
                        children: [
                          // 2. Reemplazamos el Icon() por Lottie
                          Lottie.asset(
                            'assets/animations/medical_anim.json',
